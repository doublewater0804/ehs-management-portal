...
if (typeof window !== "undefined") {
  ...
  // Only the /task/ module receives the task-specific basic-data/personnel extensions.
  ...
  if (isTaskModule) {
    if (!document.querySelector('link[data-ehs-task-basic-data-layout]')) {
      ...
      link.rel = 'stylesheet';
      link.href = './basic-data-layout.css?v=8';
    ...
    if (!document.querySelector('script[data-ehs-task-basic-data-tab-structure]')) {
      ...
      structurePatch.src = './basic-data-tab-structure.js?v=8';
    ...
    if (!document.querySelector('script[data-ehs-task-personnel-assignment]')) {
      ...
      personnel.src = './personnel-assignment.js?v=7';
  ...
  if (isFlareModule && !document.querySelector('script[data-ehs-flare-restore-actions]')) {
    ...
    flareRestoreActions.src = './restore-actions.js?v=20260824-0940';
