export const RELEASE='20260915-v2';
...
export const TW_FIELDS={department:'輪值事業部',supervisor:'督導主管',title:'職稱',supervisorMobile:'主管手機',supervisorPhone:'主管座機',leader:'組長姓名',unit:'單位',expertise:'專長',leaderMobile:'組長手機',leaderPhone:'組長座機'};
export const PERSON_FIELDS={name:'姓名',title:'職稱',unit:'單位',expertise:'專長',mobile:'手機',phone:'座機',review:'核對註記'};
...
export function mergeSeed(current,incoming,applyDuty=false){
